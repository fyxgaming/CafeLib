...
namespace CafeLib.BsvSharp.Extensions
{
    public static class BufferExtensions
    {
        ...
        public static string ToHex(this CorefxReadOnlyByteSequence data) => Encoders.Hex.EncodeSpan(data);
        public static string ToHexReverse(this CorefxReadOnlyByteSequence data) => Encoders.Hex.EncodeSpan(data);
    }
}
